...
contract TokenFactory {
     ...
     */
    function getToken(string memory _symbol) public view returns(address, string memory, string memory, uint8, string memory,
     address, bool) {
        return (
...
*/
    ...
    function createToken(
        ...
        // of the token.
        TokenTemplate tokenContract = new TokenTemplate(_name, _symbol, _decimals, _purpose, _logoURL, _logoHash, _hardCap, msg.sender,
        _contractHash);
